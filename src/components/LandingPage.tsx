      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            A powerful, intuitive task management system that helps you stay organized, 
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <p className="text-gray-600">
              Work together seamlessly with project sharing, member management, and real-time updates.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <p className="text-gray-600">
              Monitor your progress with detailed analytics, reports, and visual dashboards.
            </p>
          </div>
        </div>
        ...
        <div className="mt-20 bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Our Task Manager?</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Enterprise-grade security with reliable cloud infrastructure</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Intuitive interface that requires no training to get started</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Access your tasks from any device, anywhere, anytime</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Changes sync instantly across all your devices and team members</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Adapt the system to your workflow with flexible configurations</p>
                </div>
              </div>
      ...
      <footer className="bg-white border-t mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-600">
            <p>&copy; 2024 Task Manager. Built with Next.js and Supabase.</p>
          </div>
        </div>
      </footer>
    </div>
